...
async def cpu_reset(dut):
    ...
    dut.reset.value = 1           # De-assert reset
    await RisingEdge(dut.clk)     # Wait for a clock edge after reset
...
async def cpu_insrt_test(dut):
    ...
    assert binary_to_hex(dut.register_file.registers[18].value) == "DEADBEEF", f"expected DEADBEEF but got {binary_to_hex(dut.register_file.registers[18].value)} @ pc {binary_to_hex(dut.pc.value)}"
    ...
    assert binary_to_hex(dut.register_file.registers[19].value) == "00000AAA"
    await RisingEdge(dut.clk) # add x20 x18 x19
    assert binary_to_hex(dut.register_file.registers[20].value) == hex(expected_result)[2:].upper(),  f"expected {hex(expected_result)[2:]}  but got {binary_to_hex(dut.register_file.registers[20].value)} @ pc {binary_to_hex(dut.pc.value)}"
    ...
    assert binary_to_hex(dut.register_file.registers[21].value) == "DEAD8889"
    ...
    assert binary_to_hex(dut.register_file.registers[5].value) == "125F552D"
    await RisingEdge(dut.clk) # lw x6 0x18(x0) | x6  <= 7F4FD46A
    assert binary_to_hex(dut.register_file.registers[6].value) == "7F4FD46A"
    await RisingEdge(dut.clk) # or x7 x5 x6    | x7  <= 7F5FD56F
    assert binary_to_hex(dut.register_file.registers[7].value) == "7F5FD56F"
    ...
    assert binary_to_hex(dut.register_file.registers[22].value) == "DEADBEEF"
    ...
    assert binary_to_hex(dut.register_file.registers[22].value) == "AEAEAEAE"
    ...
    assert binary_to_hex(dut.register_file.registers[1].value) == "00000048" # stored old pc + 4

    await RisingEdge(dut.clk) # jal x1 -4
    # Check new state & ra (x1) register value
    assert binary_to_hex(dut.instruction.value) == "00C000EF"
    assert binary_to_hex(dut.pc.value) == "0000004C"
    assert binary_to_hex(dut.register_file.registers[1].value) == "00000054" # stored old pc + 4

    await RisingEdge(dut.clk) # jal x1 0xC
    # Check new state & ra (x1) register value
    assert binary_to_hex(dut.instruction.value) == "00C02383"
    assert binary_to_hex(dut.pc.value) == "00000058"
    assert binary_to_hex(dut.register_file.registers[1].value) == "00000050" # stored old pc + 4

    await RisingEdge(dut.clk) # lw x7 0xC(x0)
    assert binary_to_hex(dut.register_file.registers[7].value) == "DEADBEEF"
    ...
    assert not binary_to_hex(dut.register_file.registers[26].value) == "DEADC09A"

    await RisingEdge(dut.clk) # addi x26 x7 0x1AB
    assert binary_to_hex(dut.instruction.value) == "F2130C93"
    assert binary_to_hex(dut.register_file.registers[26].value) == "DEADC09A"

    await RisingEdge(dut.clk) # addi x25 x6 0xF21
    assert binary_to_hex(dut.register_file.registers[25].value) == "7F4FD38B"
    ...
    assert binary_to_hex(dut.register_file.registers[5].value) == "1F1FA064"
    ...
    assert binary_to_hex(dut.register_file.registers[5].value) == "2F2FA000"
    ...
    assert binary_to_hex(dut.register_file.registers[23].value) == "00000000"

    await RisingEdge(dut.clk) # slti x23 x23 0x001
    assert binary_to_hex(dut.register_file.registers[23].value) == "00000001"
    ...
    assert binary_to_hex(dut.register_file.registers[22].value) == "00000001"

    await RisingEdge(dut.clk) # sltiu x22 x19 0x001 
    assert binary_to_hex(dut.register_file.registers[22].value) == "00000000"
    ...
    assert binary_to_hex(dut.register_file.registers[18].value) == "21524445"

    await RisingEdge(dut.clk) # xori x19 x18 0x000 
    assert binary_to_hex(dut.register_file.registers[19].value) == binary_to_hex(dut.register_file.registers[18].value)
    ...
    assert binary_to_hex(dut.register_file.registers[20].value) == "FFFFFEEF"

    await RisingEdge(dut.clk) # ori x21 x20 0x000
    assert binary_to_hex(dut.register_file.registers[21].value) == binary_to_hex(dut.register_file.registers[20].value)
    ...
    assert binary_to_hex(dut.register_file.registers[18].value) == "000006EF"

    await RisingEdge(dut.clk) # andi x19 x21 0xFFF
    assert binary_to_hex(dut.register_file.registers[19].value) == binary_to_hex(dut.register_file.registers[21].value)
    assert binary_to_hex(dut.register_file.registers[19].value) == "FFFFFEEF"

    await RisingEdge(dut.clk) # andi x20 x21 0x000 
    assert binary_to_hex(dut.register_file.registers[20].value) == "00000000"
    ...
    assert binary_to_hex(dut.register_file.registers[19].value) == "FFFFEEF0"
    ...
    assert binary_to_hex(dut.register_file.registers[20].value) == "0FFFFEEF"
    ...
    assert binary_to_hex(dut.register_file.registers[21].value) == "FFFFFFEE"
    ...
    assert binary_to_hex(dut.register_file.registers[18].value) == "FFFFF8FF"
    ...
    assert binary_to_hex(dut.register_file.registers[7].value) == "00000008"

    await RisingEdge(dut.clk) # sll x18 x18 x7
    assert binary_to_hex(dut.register_file.registers[18].value) == "FFF8FF00"
    ...
    assert binary_to_hex(dut.register_file.registers[17].value) == "00000001"
    ...
    assert binary_to_hex(dut.register_file.registers[17].value) == "000711F0"
    ...
    assert binary_to_hex(dut.register_file.registers[8].value) == "00FFFFEE"
    ...
    assert binary_to_hex(dut.register_file.registers[8].value) == "FFFFFFEE"
    ...
    assert binary_to_hex(dut.register_file.registers[7].value) == "00000120"

    await RisingEdge(dut.clk) # jalr x1  -4(x7)
    assert binary_to_hex(dut.register_file.registers[1].value) == "00000118"
    assert not binary_to_hex(dut.instruction.value) == "00C00413"
    assert binary_to_hex(dut.register_file.registers[8].value) == "FFFFFFEE"
    ...
    assert binary_to_hex(dut.register_file.registers[7].value) == "00000010"
    ...
    assert binary_to_hex(dut.register_file.registers[18].value) == "FFFFFFDE"

    await RisingEdge(dut.clk) # lbu x19 -3(x7)
    assert binary_to_hex(dut.register_file.registers[19].value) == "000000BE"

    await RisingEdge(dut.clk) # lh x20 -3(x7) 
    assert binary_to_hex(dut.register_file.registers[20].value) == "0FFFFEEF"

    await RisingEdge(dut.clk) # lh x20 -6(x7)
    assert binary_to_hex(dut.register_file.registers[20].value) == "FFFFDEAD"

    await RisingEdge(dut.clk) # lhu x21 -3(x7) 
    assert binary_to_hex(dut.register_file.registers[21].value) == "FFFFFFEE"

    await RisingEdge(dut.clk) # lhu x21 -6(x7)
    assert binary_to_hex(dut.register_file.registers[21].value) == "0000DEAD"