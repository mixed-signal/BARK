...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+3,0,"address",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 5,0);
    ...
    tracep->declBus(c+15,0,"ADDR_WIDTH",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    tracep->declBus(c+16,0,"NVM_INIT",-1, VerilatedTraceSigDirection::NONE, VerilatedTraceSigKind::PARAMETER, VerilatedTraceSigType::LOGIC, false,-1, 31,0);
    ...
    tracep->declBit(c+8,0,"write_enable",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1);
    tracep->declBus(c+9,0,"address",-1, VerilatedTraceSigDirection::INPUT, VerilatedTraceSigKind::WIRE, VerilatedTraceSigType::LOGIC, false,-1, 5,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_0_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+3,(vlSelfRef.address),6);
    bufp->fullIData(oldp+4,(vlSelfRef.data_in),32);
    bufp->fullBit(oldp+5,(vlSelfRef.reset));
    bufp->fullIData(oldp+6,(vlSelfRef.data_out),32);
    bufp->fullBit(oldp+7,(vlSelfRef.memory__DOT__clk));
    bufp->fullBit(oldp+8,(vlSelfRef.memory__DOT__write_enable));
    bufp->fullCData(oldp+9,(vlSelfRef.memory__DOT__address),6);
    bufp->fullIData(oldp+10,(vlSelfRef.memory__DOT__data_in),32);
    bufp->fullBit(oldp+11,(vlSelfRef.memory__DOT__reset));
    bufp->fullIData(oldp+12,(vlSelfRef.memory__DOT__data_out),32);
    bufp->fullIData(oldp+13,(vlSelfRef.memory__DOT__unnamedblk1__DOT__i),32);
}
